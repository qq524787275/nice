package com.zhuzichu.library.view.drop;
...
public class DropManager {
    ...
    static final int TEXT_SIZE = DensityUtils.sp2px(Nice.context,12); // 12sp

    static final int CIRCLE_RADIUS = DensityUtils.dip2px(Nice.context,10); // 10dip
    ...
    private int[] explosionResIds = new int[]{
            R.drawable.view_explosion_one,
            R.drawable.view_explosion_two,
            R.drawable.view_explosion_three,
            R.drawable.view_explosion_four,
            R.drawable.view_explosion_five
    };

    // interface
    public void init(Context context, DropCover dropCover, DropCover.IDropCompletedListener listener) {
        this.isTouchable = true;
        this.statusBarHeight = DensityUtils.getStatuBarH(context);
