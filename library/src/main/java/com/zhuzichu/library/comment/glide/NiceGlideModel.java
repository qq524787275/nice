...
public class NiceGlideModel extends AppGlideModule {
    ...
    public static void expect(String url, UiOnProgressListener listener) {
        NiceGlideModel.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements NiceGlideModel.ResponseProgressListener {
