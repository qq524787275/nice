...
public class EmojiKeyboard {
    ...
    public EmojiKeyboard(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView, View contentView, RecyclerView recyclerView) {
        init(activity, editText, emojiPanelView, emojiPanelSwitchView, contentView, recyclerView);
    }

    private void init(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView, View contentView, RecyclerView recyclerView) {
        ...
        this.recyclerView.setOnTouchListener((view, motionEvent) -> {
        ...
        //用于弹出表情面板的View
        emojiPanelSwitchView.setOnClickListener(new OnClickListener() {
            @Override
